...
import center from '@/views/center'
    ...
    import discusszaixiankefu from '@/views/modules/discusszaixiankefu/list'
    import orders from '@/views/modules/orders/list'
    import storeup from '@/views/modules/storeup/list'
    import zaixiankefu from '@/views/modules/zaixiankefu/list'
...
const routes = [{
	...
	path: '/shangpinxinxi',
        ...
        component: shangpinxinxi
          ...
          ,{
	path: '/discusszaixiankefu',
        name: '在线客服评论',
        component: discusszaixiankefu
      }
          ,{
        path: '/orders/:status',
        name: '订单管理',
